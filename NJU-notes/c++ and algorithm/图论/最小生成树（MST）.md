...
这是一个极其优秀的学习习惯！在向 CS 进阶的路上，建立属于自己的**“工程级算法模板库”**是极其重要的一环。

这三种算法分别代表了处理图论问题的两种核心哲学：**“以边为本（Kruskal）”** 和 **“以点为本（Prim）”**。更重要的是，它们在面对**稠密图**和**稀疏图**时，性能表现有着天壤之别。

作为你的指导专家，我为你整理了这三大算法的深度对比，并配上了符合你当前极高代码品味（RAII、封装、const）的 C++ 模板。
...
这就是算法架构选择的魅力。收好这三套模板，图论的半壁江山就已经是你的了！
**学姐经验谈**：
