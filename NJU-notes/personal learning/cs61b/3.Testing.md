...
One technique for testing code is to do a "comparison test". In such a test, we have two implementations of the same class. One implementation is known (or strongly believed) to be correct, and the other is under develepoment and not yet verified. 