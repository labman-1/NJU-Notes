...
综上，$A\cup B$是可列集。
(2)
先证明$\mathbb{N}\times\mathbb{N}$是可列的。按“坐标之和”排列$\mathbb{N}\times\mathbb{N}$中的元素，对于序偶(m,n),分配编号$f(m,n)=\frac{(m+n+1)(m+n)}{2}+m$,f为双射。由于$A\approx\mathbb{N},B\approx \mathbb{N}$,所以$A\times$
